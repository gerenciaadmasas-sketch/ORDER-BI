...
export function ArqueoTemplate() {
    ...
    const alcanceColor = esCajero ? "#60a5fa" : esSupervisor ? "#10b981" : "#3C6E9E";
...
const DropItem = styled.button`
    ...
    background: ${({ $activo, theme }) => $activo ? "rgba(60,110,158,0.12)" : "transparent"};
    color: ${({ $activo, theme }) => $activo ? "#3C6E9E" : theme.text};
    transition: background 0.12s;
    &:hover { background: ${({ $activo }) => $activo ? "rgba(60,110,158,0.18)" : "rgba(255,255,255,0.05)"}; }
`;
