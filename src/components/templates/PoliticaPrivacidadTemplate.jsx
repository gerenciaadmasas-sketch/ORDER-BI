...
const SECCIONES = [
    {
        ...
        texto: `ADMA BI, con correo de contacto gerencia.adma.sas@gmail.com, con domicilio en Bogotá, Colombia, es el responsable del tratamiento de los datos personales recolectados a través de la plataforma ORDER BI.`,
    },
    {
    ...
    return (
        <Pagina>
            <Contenedor>
                ...
                <Intro>
                    En ADMA BI nos comprometemos con la protección de sus datos personales. Esta política describe cómo recolectamos, usamos y protegemos la información que nos comparte al utilizar nuestra plataforma ORDER BI.
                </Intro>
