    ...
    return (
        <Wrap $isopen={state}>
            ...
            <LogoArea $isopen={state}>
                ...
                {state && <LogoNombre><LogoNombreOrder>ORDER</LogoNombreOrder> BI</LogoNombre>}
                <LogoNombreMobile><LogoNombreOrder>ORDER</LogoNombreOrder> BI</LogoNombreMobile>
...
const BtnCerrarMobile = styled.button`
    ...
    @media (max-width: 767px) {
        ...
        &:hover  { background: rgba(60,110,158, 0.12); border-color: rgba(60,110,158, 0.55); }
