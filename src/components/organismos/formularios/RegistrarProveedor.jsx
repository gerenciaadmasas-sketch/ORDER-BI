...
const HeadIcon = styled.div`width:44px;height:44px;border-radius:14px;background:rgba(60,110,158,.15);border:1px solid rgba(60,110,158,.3);display:flex;align-items:center;justify-content:center;font-size:22px;color:#3C6E9E;flex-shrink:0;`;
...
const TipoOpt     = styled.button`display:flex;flex-direction:column;align-items:center;gap:4px;padding:14px 10px;border-radius:14px;border:1px solid ${p=>p.$active?"#3C6E9E":"rgba(255,255,255,.08)"};background:${p=>p.$active?"rgba(60,110,158,.12)":"rgba(255,255,255,.03)"};color:${p=>p.$active?"#3C6E9E":"rgba(255,255,255,.35)"};cursor:pointer;font-family:"Poppins",sans-serif;font-size:13px;font-weight:700;transition:.2s;svg{font-size:22px;}`;
